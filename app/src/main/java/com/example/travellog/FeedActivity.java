...
public class FeedActivity extends AppCompatActivity {
    ...
    int age;
    int level;
    private Button actionButton; // Changed from logOutButton for dynamic text
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_feed); // Ensure this is your feed activity XML
        ...
        actionButton = findViewById(R.id.buttonlogout); // Assuming R.id.buttonlogout is your button's ID
        ...
        if (ANONYMOUS_NICKNAME.equals(nickname)) {
            ...
            updateActionButton(true); // User is anonymous
        } else {
            ...
            updateActionButton(false); // User is logged in
        }
    ...
    private void updateActionButton(boolean isAnonymous) {
        if (actionButton == null) {
            Log.e(TAG, "updateActionButton: actionButton is null. Check ID in XML.");
            return;
        }
        ...
        if (isAnonymous) {
            ...
            actionButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Log.d(TAG, "onClick: Sign In button clicked (user was anonymous).");
                    Intent intent = new Intent(FeedActivity.this, LoginActivity.class);
                    // Flags to clear stack if navigating to Login from a state where user isn't really "in" the app flow
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                    finish(); // Finish FeedActivity as we are going to a new auth flow
                }
            });
        } else {
